...
logger = logging.getLogger("neurotopo.analysis.semantic")

# Default cache directory
DEFAULT_CACHE_DIR = Path.home() / ".cache" / "neurotopo" / "semantic"
...
class SemanticAnalyzer:
    ...
    - Cache is stored in ~/.cache/neurotopo/semantic/ by default
    """
